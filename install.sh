...
display_welcome() {
  ...
  echo -e "${BLUE}[+]                  © Ryuu Lyncxx                [+]${NC}"
  echo -e "${BLUE}[+]                                               [+]${NC}"
  echo -e "${BLUE}[+] ============================================= [+]${NC}"
  echo -e ""
  echo -e "script ini di buat untuk mempermudah penginstalasian thema pterodactyl,"
  echo -e "dilarang keras untuk memperjual belikan, ngebatu? inget karma nya aja."
  echo -e ""
  echo -e "𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 :"
  echo -e "+62 858-8873-9162"
  echo -e "𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠 :"
  echo -e "@drags_pedia"
  echo -e "𝗖𝗥𝗘𝗗𝗜𝗧𝗦 :"
  echo -e "@Ryuu Lyncxx"
...
install_jq() {
  ...
  if [ $? -eq 0 ]; then
    ...
    echo -e "                                                       "
    echo -e "${YELLOW}[+] =============================================== [+]${NC}"
    echo -e "${YELLOW}[+]              INSTALL JQ GAGAL                   [+]${NC}"
    echo -e "${YELLOW}[+] =============================================== [+]${NC}"
    exit 1
  fi
  echo -e "                                                       "
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] ============================================= [+]${NC}"
  echo -e "${BLUE}[+]               LICENSE Ryuu Lyncxx             [+]${NC}"
  echo -e "${BLUE}[+] ============================================= [+]${NC}"
  echo -e "                                                       "
